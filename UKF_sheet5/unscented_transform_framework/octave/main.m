...
plot(mu(1),mu(2),'ro','markersize',12, 'linewidth',2)
%legend('original distribution')
drawprobellipse(mu, sigma, 0.9, 'r');
plot(sigma_points(1,:),sigma_points(2,:),'kx','markersize', 10, 'linewidth',2)
...
plot(mu_trans(1),mu_trans(2),'bo','markersize', 12, 'linewidth',2)
%legend('transformed distribution')
drawprobellipse(mu_trans, sigma_trans, 0.9, 'b');
plot(sigma_points_trans(1,:),sigma_points_trans(2,:),'kx','markersize', 10, 'linewidth',2)
...
% Print and save plot
print('../plots/unscented_Function2_a06.png', '-dpng')
