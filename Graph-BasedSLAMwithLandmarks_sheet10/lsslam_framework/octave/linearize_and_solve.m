...
for eid = 1:length(g.edges)
  ...
  if (strcmp(edge.type, 'P') != 0)
    ...
    H(edge.toIdx:edge.toIdx+2, edge.fromIdx:edge.fromIdx+2) += H(edge.fromIdx:edge.fromIdx+2, edge.toIdx:edge.toIdx+2)';
...
b(edge.fromIdx:edge.fromIdx+2) += A' * edge.information' * e;
    ...
    H(edge.toIdx:edge.toIdx+1, edge.fromIdx:edge.fromIdx+2) += H(edge.fromIdx:edge.fromIdx+2, edge.toIdx:edge.toIdx+1)';
